        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitsPerPackage = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: true),
                    CoveragePerPackage = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: true),
                    WastageRate = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecValue = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceTiers_ProductId_TierName",
                schema: "catalog",
                table: "PriceTiers",
                columns: new[] { "ProductId", "TierName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductAliases_AliasName",
                schema: "catalog",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSpecs_ProductId_SpecKey",
                schema: "catalog",
                table: "ProductSpecs",
